            ...
            <div class="bg-primary-chathams-blue-reverse">
              <div class="shell section-top-57 section-bottom-30 section-md-top-210 section-lg-top-260">
                ...
                <ul class="list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-extra-small list-inline-icon-white p offset-top-30 offset-md-top-40 offset-lg-top-125">
                  ...
                  <li><a href="destinations.html" class="text-white">About</a></li>
                  <li>Privacy Policy
                  </li>
                </ul>
              </div>
          ...
          <div class="shell">
            <div class="range range-xs-center range-sm-left">
              <div class="cell-xs-10 cell-lg-8">
                ...
                <dl class="list-terms">
                  <dt>
                    <div class="h6 text-bold">General Information</div>
                  </dt>
                  <dd class="offset-top-10">
                  ...
                  <dt class="offset-top-35 offset-md-top-65">
                    <div class="h6 text-bold">Right to Access, Correct and Delete Data and to Object to Data Processing</div>
                  </dt>
                  <dd class="offset-top-10">
                  ...
                  <dt class="offset-top-35 offset-md-top-65">
                    <div class="h6 text-bold">Management of Personal Data</div>
                  </dt>
                  <dd class="offset-top-10">
                  ...
                  <dt class="offset-top-35 offset-md-top-65">
                    <div class="h6 text-bold">Information We Collect</div>
                  </dt>
                  <dd class="offset-top-10">
                  ...
                  <dt class="offset-top-35 offset-md-top-65">
                    <div class="h6 text-bold">How We Use Your Information</div>
                  </dt>
                  <dd class="offset-top-10">
                  ...
                  <dt class="offset-top-35 offset-md-top-65">
                    <div class="h6 text-bold">Sharing Your Information</div>
                  </dt>
                  <dd class="offset-top-10">
                ...
                <p class="offset-top-15 offset-md-top-35"><a href="mailto:#" class="text-primary">privacy@smarttravel.pk</a></p>
              </div>
            </div>
          </div>
        </section>
