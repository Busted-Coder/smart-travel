...
<html lang="en" class="wide wow-animation smoothscroll scrollTo">
      ...
      <main class="page-content">
        ...
        <section class="section-90 section-md-111">
          <div class="shell">
            <h2 class="text-bold text-center">3 Columns Layout</h2>
            <hr class="divider bg-chathams-blue">
            <div class="range range-xs-center offset-top-30">
              <div class="cell-sm-8 cell-md-12">
                <!-- Owl Carousel-->
                <div data-items="1" data-sm-items="1" data-md-items="3" data-loop="false" data-stage-padding="5" data-margin="60" data-nav="false" data-dots="true" class="owl-carousel owl-carousel-classic owl-dots-60">
                  <div class="owl-item">
                    <!-- Classic Blockquote-->
        ...
        <section class="section-90 section-md-111 bg-zircon">
          <div class="shell">
            <h2 class="text-bold text-center">Alternative 3 Columns Layout</h2>
            <hr class="divider bg-chathams-blue">
            <div class="range range-xs-center offset-top-30">
              <div class="cell-sm-10 cell-md-4">
                <!-- Boxed Blockquote-->
                <blockquote class="quote quote-boxed text-left offset-top-25">
                  <div class="unit unit-middle unit-horizontal unit-spacing-xs">
                    <div class="unit-left"><img src="<?php echo PATH; ?>images/users/user-roger-washington-40x40.jpg" width="40" height="40" alt="" class="img-circle img-responsive center-block"></div>
                    <div class="unit-body">
                      <p class="quote-author"><a href="team-member-profile.html" class="text-gray">Roger Washington</a></p>
          ...
          <div class="shell">
            ...
            <div class="range range-xs-center offset-top-30">
              <div class="cell-sm-8 cell-lg-6">
                <!-- Owl Carousel-->
                <div data-items="1" data-loop="false" data-stage-padding="5" data-margin="10" data-nav="false" data-dots="true" class="owl-carousel owl-carousel-classic owl-dots-45">
                  <div class="owl-item">
                    <!-- Classic Blockquote-->
                    <blockquote class="quote quote-classic text-center offset-top-25"><span class="icon icon-xs fa fa-quote-left text-botticelli"></span>
