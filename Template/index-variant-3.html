    ...
    <div class="page text-center">
      ...
      <header class="page-head slider-menu-position">
        ...
        <div class="rd-navbar-wrap">
          <nav data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-md-stick-up-offset="100px" data-lg-stick-up-offset="75px" data-auto-height="false" class="rd-navbar rd-navbar-top-panel rd-navbar-default rd-navbar-white rd-navbar-sidebar-toggle" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fixed" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              <div class="rd-navbar-sidebar-panel-dub veil-lg">
                <div class="form-search-wrap">
                  <!-- RD Search Form-->
                  <form action="search-results.html" method="GET" class="form-search rd-search">
                    <div class="form-group">
                      <label for="rd-navbar-form-search-widget-bottom-dub" class="form-label form-search-label rd-input-label">Search</label>
                      <input id="rd-navbar-form-search-widget-bottom-dub" type="text" name="s" autocomplete="off" class="form-search-input form-control form-control-gray-lightest"/>
                    </div>
              ...
              <div class="rd-navbar-menu-wrap">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    ...
                    <div class="rd-navbar-sidebar-panel veil reveal-lg-inline-block">
                      <div class="form-search-wrap">
                        <!-- RD Search Form-->
                        <form action="search-results.html" method="GET" class="form-search rd-search">
                          <div class="form-group">
                            <label for="rd-navbar-form-search-widget-bottom" class="form-label form-search-label rd-input-label">Search</label>
                            <input id="rd-navbar-form-search-widget-bottom" type="text" name="s" autocomplete="off" class="form-search-input form-control form-control-gray-lightest"/>
                          </div>
                          <button type="submit" class="form-search-submit"><span class="fa fa-search"></span></button>
                        </form>
                      </div>
        ...
        <div data-height="" data-min-height="200px" data-slide-effect="fade" data-simulate-touch="false" data-loop="false" class="swiper-container swiper-slider swiper-slider-offset-top-inverse context-dark text-lg-left">
          <div class="swiper-wrapper">
                  ...
                  <div class="shell">
                    <div class="range range-xs-center range-xs-middle range-lg-left section-lg-top-50 section-xl-top-75">
                      <div class="cell-xs-10 cell-md-7 cell-lg-6 cell-xl-7">
                        <h1 data-caption-animate="fadeInDown" data-caption-delay="200" class="text-bold">Providing quality service <br class="veil reveal-xl-inline-block"> at unbeatable rates.</h1>
                        <div data-caption-animate="fadeInUp" data-caption-delay="600" class="offset-top-20 offset-lg-top-49">
                          <p class="h6 text-mercury">We provide affordable and reliable bus booking services online <br class="veil reveal-xl-inline-block"> all over the world.</p>
                        </div>
            ...
            <div data-slide-bg="images/backgrounds/background-07-1920x900.jpg" class="swiper-slide">
              <div class="swiper-slide-caption-wrap">
                <div class="swiper-slide-caption">
                  <div class="shell">
                    <div class="range range-xs-center range-xs-middle range-lg-left section-lg-top-50 section-xl-top-75">
              ...
              <div class="range range-xs-center range-xs-middle range-lg-right">
                <div class="cell-xs-10 cell-sm-8 cell-md-5 cell-lg-4 offset-top-40 offset-top-0 swiper-center-caption swiper-center-caption-centered">
                  ...
                  <div class="panel panel-lg panel-lg-vertical bg-overlay-chathams-blue text-lg-left">
                    ...
                    <form class="offset-top-20">
                      <div class="group group-top">
                        <div class="group-item element-fullwidth">
                          <div class="form-group text-left">
                            <label for="form-filter-location-from-first" class="form-label form-label-outside">Traveling From</label>
                            <div class="select2-whitout-border shadow-drop-md">
                              <select id="form-filter-location-from-first" name="location-from" data-minimum-results-for-search="Infinity" class="form-control">
                        ...
                        <div class="group-item element-fullwidth">
                          <div class="form-group text-left">
                            <label for="form-filter-location-to-first" class="form-label form-label-outside">Traveling To</label>
                            <div class="select2-whitout-border shadow-drop-md">
                              <select id="form-filter-location-to-first" name="location-to" data-minimum-results-for-search="Infinity" class="form-control">
                        ...
                        <div class="group-item element-fullwidth element-fullwidth-xs">
                          <div class="form-group text-left">
                            <label for="form-filter-location-from-date-first" class="form-label form-label-outside">Depart Date</label>
                            <div class="select2-whitout-border shadow-drop-md">
                              <select id="form-filter-location-from-date-first" name="date-from" data-minimum-results-for-search="Infinity" class="form-control">
                        ...
                        <div class="group-item element-fullwidth element-fullwidth-xs">
                          <div class="form-group text-left">
                            <label for="form-filter-location-to-date-first" class="form-label form-label-outside">Ticket Type</label>
                            <div class="select2-whitout-border shadow-drop-md">
                              <select id="form-filter-location-to-date-first" name="date-to" data-minimum-results-for-search="Infinity" class="form-control">
                        ...
                        <div class="group-item element-fullwidth">
                          <button type="button" class="shadow-drop-md btn btn-block btn-ripe-lemon">search</button>
                        </div>
                      </div>
                    </form>
                  </div>
      ...
      <main id="section-change-color" class="page-content">
          ...
          <div class="shell">
            ...
            <div class="range range-xs-center offset-top-69">
              <div class="cell-xs-6 cell-sm-5 cell-md-3">
                <!-- Box Icon-->
                <div class="box-icon"><span class="icon icon-xlg icon-circle icon-transparent-primary-filled mdi mdi-wifi"></span>
                  <div class="offset-top-20">
                    <h5 class="text-bold">Free Wi-Fi</h5>
                  </div>
                  <div class="offset-top-15">
                    <hr class="divider divider-xs bg-chathams-blue"/>
                  </div>
                  <div class="offset-top-15">
              ...
              <div class="cell-xs-6 cell-sm-5 cell-md-3 offset-top-60 offset-xs-top-0">
                <!-- Box Icon-->
                <div class="box-icon"><span class="icon icon-xlg icon-circle icon-transparent-primary-filled mdi mdi-taxi"></span>
                  <div class="offset-top-20">
              ...
              <div class="cell-xs-6 cell-sm-5 cell-md-3 offset-top-60 offset-md-top-0">
                <!-- Box Icon-->
                <div class="box-icon"><span class="icon icon-xlg icon-circle icon-transparent-primary-filled mdi mdi-seat-recline-extra"></span>
                  <div class="offset-top-20">
              ...
              <div class="cell-xs-6 cell-sm-5 cell-md-3 offset-top-60 offset-md-top-0">
                <!-- Box Icon-->
                <div class="box-icon"><span class="icon icon-xlg icon-circle icon-transparent-primary-filled mdi mdi-cash-multiple"></span>
                  <div class="offset-top-20">
                    <h5 class="text-bold">Online Ticketing</h5>
                  </div>
                  <div class="offset-top-15">
                    <hr class="divider divider-xs bg-chathams-blue"/>
                  </div>
                  <div class="offset-top-15">
                    <p class="text-gray">Visa, MasterCard, etc</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="shell">
            ...
            <div class="range range-xs-center offset-top-60">
              <div class="cell-xs-10 cell-sm-6">
                <!-- Post Ticket--><a href="single-ticket.html" class="post-ticket post-ticket-boxed">
                  ...
                  <div class="post-ticket-body text-left">
                    ...
                    <div>
                      <ul class="group-xs list list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-white">
                        <li class="post-ticket-boxed-title text-bold">Washington, D.C.</li>
                        <li class="post-ticket-boxed-title text-bold">Boston</li>
                      </ul>
                    </div>
                  </div></a>
              </div>
              <div class="cell-xs-10 cell-sm-6 offset-top-30 offset-sm-top-0">
                <!-- Post Ticket--><a href="single-ticket.html" class="post-ticket post-ticket-boxed">
                  ...
                  <div class="post-ticket-body text-left">
                    ...
                    <div>
                      <ul class="group-xs list list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-white">
                        <li class="post-ticket-boxed-title text-bold">Sacramento</li>
                        <li class="post-ticket-boxed-title text-bold">San Francisco</li>
                      </ul>
                    </div>
                  </div></a>
              </div>
              <div class="cell-xs-10 cell-sm-6 offset-top-30 offset-sm-top-25">
                <!-- Post Ticket--><a href="single-ticket.html" class="post-ticket post-ticket-boxed">
                  <div class="post-ticket-header"><img src="images/blog/post-01-570x280.jpg" width="570" height="280" alt="" class="img-responsive"/>
                    <div class="post-ticket-price-svg-wrap">
                      <div class="post-ticket-price-svg"><svg viewBox="0 0 140 36"><path d="m 0.01190457,18.011904 0,-17.99999966 70.00000343,0 69.999992,0 0,5.50000006 c 0,4.157048 -0.35675,5.4999996 -1.46104,5.4999996 -2.34992,0 -5.53896,4.138795 -5.53896,7.188561 0,3.025049 3.05738,6.811439 5.5,6.811439 1.15152,0 1.5,1.277778 1.5,5.5 l 0,5.5 -69.999992,0 -70.00000343,0 0,-18 z"/></svg>
                        <div class="post-ticket-price text-bold text-shark"><span>$</span><span>16.00</span><span>/pers.</span></div>
                      </div>
                  ...
                  <div class="post-ticket-body text-left">
                    ...
                    <div>
                      <ul class="group-xs list list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-white">
                        <li class="post-ticket-boxed-title text-bold">Boston</li>
                        <li class="post-ticket-boxed-title text-bold">New York</li>
                      </ul>
                    </div>
                  </div></a>
              </div>
              <div class="cell-xs-10 cell-sm-6 offset-top-30 offset-sm-top-25">
                <!-- Post Ticket--><a href="single-ticket.html" class="post-ticket post-ticket-boxed">
                  <div class="post-ticket-header"><img src="images/blog/post-06-570x280.jpg" width="570" height="280" alt="" class="img-responsive"/>
                    <div class="post-ticket-price-svg-wrap">
                      <div class="post-ticket-price-svg"><svg viewBox="0 0 140 36"><path d="m 0.01190457,18.011904 0,-17.99999966 70.00000343,0 69.999992,0 0,5.50000006 c 0,4.157048 -0.35675,5.4999996 -1.46104,5.4999996 -2.34992,0 -5.53896,4.138795 -5.53896,7.188561 0,3.025049 3.05738,6.811439 5.5,6.811439 1.15152,0 1.5,1.277778 1.5,5.5 l 0,5.5 -69.999992,0 -70.00000343,0 0,-18 z"/></svg>
                        <div class="post-ticket-price text-bold text-shark"><span>$</span><span>16.00</span><span>/pers.</span></div>
                      </div>
                  ...
                  <div class="post-ticket-body text-left">
                    ...
                    <div>
                      <ul class="group-xs list list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-white">
                        <li class="post-ticket-boxed-title text-bold">New York</li>
                        <li class="post-ticket-boxed-title text-bold">Chicago</li>
                      </ul>
                    </div>
                  </div></a>
              </div>
              <div class="cell-xs-10 cell-sm-6 offset-top-30 offset-sm-top-25">
                <!-- Post Ticket--><a href="single-ticket.html" class="post-ticket post-ticket-boxed">
                  ...
                  <div class="post-ticket-body text-left">
                    ...
                    <div>
                      <ul class="group-xs list list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-white">
                        <li class="post-ticket-boxed-title text-bold">San Diego</li>
                        <li class="post-ticket-boxed-title text-bold">Huntington Beach</li>
                      </ul>
                    </div>
                  </div></a>
              </div>
          ...
          <div data-on="false" data-md-on="true" class="bg-gray-base context-dark rd-parallax">
            ...
            <div data-speed="0" data-type="html" data-md-fade="false" class="rd-parallax-layer">
              <div class="shell section-top-90 section-bottom-90 section-md-top-144 section-md-bottom-130">
                <div>
                  <h5 class="text-bold text-white">Special Service</h5>
                </div>
                <div class="offset-top-10">
                  <h2 class="text-bold text-white">Bus Rental with Driver</h2>
                </div>
                <div class="offset-top-42"><a href="deals.html" class="btn btn-ripe-lemon">Book Now</a></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="section-90 section-md-111">
          <div class="shell">
            ...
            <hr class="divider bg-chathams-blue">
            <div class="range range-xs-center offset-top-60">
              <div class="cell-xs-10 cell-sm-7 cell-md-4 post-masonry-without-insets">
                <article class="post post-masonry">
                  ...
                  <section class="post-content text-left">
                    ...
                    <div class="post-title offset-top-20">
                      <h6 class="text-bold text-primary"><a href="single-post.html">5 Reasons to Take the Bus in the USA</a></h6>
                    </div>
                    <!-- Post Body-->
                    <div class="post-body offset-top-10">
                      <p class="text-gray-darker">Taking the bus may not be the number one mode of transport that comes to mind when planning your trip across the US. From plenty of opportunities and open roads to drive on, to the convenience of taking a plane, why should you consider taking the bus in the US? Here are our favorite reasons why!</p>
                      <div class="offset-top-20">
                        <div class="tags group group-sm"><a href="#" class="btn-xs btn-tag btn btn-ripe-lemon">Travel</a><a href="#" class="btn-xs btn-tag btn btn-ripe-lemon">USA</a>
                        </div>
                      </div>
                    </div>
                  </section>
              ...
              <div class="cell-xs-10 cell-sm-7 cell-md-4 offset-top-30 offset-md-top-0 post-masonry-without-insets">
                <article class="post post-masonry">
                  <!-- Post media-->
                  <header class="post-media"><img src="images/blog/post-08-370x240.jpg" width="370" height="240" alt="" class="img-responsive center-block"/>
                  </header>
                  <!-- Post content-->
                  <section class="post-content text-left">
                    <ul class="list list-inline list-inline-dots list-inline-8 list-inline-0 text-gray">
                      <li class="offset-top-0"><span style="position: relative; top: -1px;" class="icon icon-xxs mdi mdi-calendar text-gray text-middle"></span><span class="inset-left-10">2 days ago</span></li>
                      <li><span>by <a href="team-member-profile.html" class="text-orange-peel">Joyce Contreras</a></span></li>
                    </ul>
                    <!-- Post Title-->
                    <div class="post-title offset-top-20">
                      <h6 class="text-bold text-primary"><a href="single-post.html">Bus Booking in USA – 7 Things You Need to Know Before Booking Your Ticket</a></h6>
                    </div>
                    <!-- Post Body-->
                    <div class="post-body offset-top-10">
                      <p class="text-gray-darker">Reading reviews about bus travel in the United States reveals one thing: Doing your research before clicking the “buy” button goes a long way. Lucky for you, we’ve done the brunt of the research! Here’s what you need to know before taking booking your bus ticket to the US!</p>
                      <div class="offset-top-20">
                        <div class="tags group group-sm"><a href="#" class="btn-xs btn-tag btn btn-ripe-lemon">Travel</a><a href="#" class="btn-xs btn-tag btn btn-ripe-lemon">USA</a>
                        </div>
                      </div>
              ...
              <div class="cell-xs-10 cell-sm-7 cell-md-4 offset-top-30 offset-md-top-0 post-masonry-without-insets">
                <article class="post post-masonry">
                  <!-- Post media-->
                  <header class="post-media"><img src="images/blog/post-10-370x240.jpg" width="370" height="240" alt="" class="img-responsive center-block"/>
                  </header>
                  <!-- Post content-->
                  <section class="post-content text-left">
                    <ul class="list list-inline list-inline-dots list-inline-8 list-inline-0 text-gray">
                      <li class="offset-top-0"><span style="position: relative; top: -1px;" class="icon icon-xxs mdi mdi-calendar text-gray text-middle"></span><span class="inset-left-10">2 days ago</span></li>
                      <li><span>by <a href="team-member-profile.html" class="text-orange-peel">Laura Wallace</a></span></li>
                    </ul>
                    <!-- Post Title-->
                    <div class="post-title offset-top-20">
                      <h6 class="text-bold text-primary"><a href="single-post.html">Wi-Fi on Buses: How Often Does It Work In the United States?</a></h6>
                    </div>
                    <!-- Post Body-->
                    <div class="post-body offset-top-10">
                      <p class="text-gray-darker">The main selling point for bus companies is that taking the bus is cheaper than other means of transportation. The bus is still relevant today, but more and more, bus companies are focusing on new advantages to woo customers: modernized buses, more comfortable seats, and onboard Wi-Fi on the bus.</p>
                      <div class="offset-top-20">
                        <div class="tags group group-sm"><a href="#" class="btn-xs btn-tag btn btn-ripe-lemon">Travel</a><a href="#" class="btn-xs btn-tag btn btn-ripe-lemon">USA</a>
                        </div>
                      </div>
            ...
            <div class="offset-top-60"><a href="blog-masonry.html" class="btn btn-default">View All News</a></div>
          </div>
        </section>
        ...
        <div class="shell">
          <div class="range range-xs-center range-sm-middle range-md-justify">
            ...
            <div class="cell-sm-8 cell-md-6 text-sm-right offset-top-30 offset-sm-top-0">
              <p class="font-accent"><span class="small text-gray">&copy; <span id="copyright-year"></span> All Rights Reserved Terms of Use and <a href="privacy.html">Privacy Policy</a></span></p>
            </div>
          </div>
        </div>
      </footer>
